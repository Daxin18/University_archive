...
namespace Bocian.Migrations
{
    ...
    [Migration("20230118170730_MoreSeeeeed")]
    partial class MoreSeeeeed
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bocian.ViewModels.AddressVm", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Bocian.ViewModels.ShopIndexVm", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Bocian.ViewModels.ShopIndexVm", b =>
                {
                    b.HasOne("Bocian.ViewModels.AddressVm", "Address")
                        .WithMany()
                        .HasForeignKey("AddressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
