...
namespace Bocian.Migrations
{
    ...
    [Migration("20230118233633_AddMoreOrders")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bocian.Models.LoyaltyScheme", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 3,
                            DiscountPrice = 8.00m,
                            EndDate = new DateOnly(2023, 1, 18),
                            PointPrice = 500,
                            ProductId = 2,
                            StartDate = new DateOnly(1, 1, 1)
                        });
            ...
            modelBuilder.Entity("Bocian.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            CartId = 2,
                            ClientId = 4,
                            OrderedAt = new DateTimeOffset(new DateTime(2023, 1, 12, 15, 18, 5, 0, DateTimeKind.Unspecified), new TimeSpan(0, 1, 0, 0, 0)),
                            PaymentId = 2,
                            Status = 0
                        },
                        new
                        {
                            ...
                            CartId = 3,
                            ClientId = 5,
                            OrderedAt = new DateTimeOffset(new DateTime(2023, 1, 11, 4, 13, 18, 0, DateTimeKind.Unspecified), new TimeSpan(0, 1, 0, 0, 0)),
                            PaymentId = 3,
                            Status = 0
                        },
                        new
                        {
                            ...
                            CartId = 4,
                            ClientId = 6,
                            OrderedAt = new DateTimeOffset(new DateTime(2023, 1, 15, 21, 37, 59, 0, DateTimeKind.Unspecified), new TimeSpan(0, 1, 0, 0, 0)),
                            PaymentId = 4,
                            Status = 0
                        },
                        new
                        ...
                        new
                        {
                            ...
                            ClientId = 5,
                            EmployeeId = 1001,
                            OrderedAt = new DateTimeOffset(new DateTime(2023, 1, 13, 9, 37, 10, 0, DateTimeKind.Unspecified), new TimeSpan(0, 1, 0, 0, 0)),
                            PaymentId = 1002,
                            Status = 2
                        },
                        new
                        {
                            ...
                            ClientId = 6,
                            EmployeeId = 1001,
                            OrderedAt = new DateTimeOffset(new DateTime(2023, 1, 14, 9, 37, 10, 0, DateTimeKind.Unspecified), new TimeSpan(0, 1, 0, 0, 0)),
                            PaymentId = 1003,
                            Status = 3
                        },
                        new
                        {
                            ...
                            ClientId = 4,
                            EmployeeId = 1001,
                            OrderedAt = new DateTimeOffset(new DateTime(2023, 1, 15, 9, 37, 10, 0, DateTimeKind.Unspecified), new TimeSpan(0, 1, 0, 0, 0)),
                            PaymentId = 1004,
                            Status = 4
                        },
                        new
                        {
                            ...
                            ClientId = 5,
                            EmployeeId = 1001,
                            OrderedAt = new DateTimeOffset(new DateTime(2023, 1, 16, 9, 37, 10, 0, DateTimeKind.Unspecified), new TimeSpan(0, 1, 0, 0, 0)),
                            PaymentId = 1005,
                            Status = 5
                        },
                        new
                        {
                            ...
                            ClientId = 6,
                            EmployeeId = 1001,
                            OrderedAt = new DateTimeOffset(new DateTime(2023, 1, 17, 9, 37, 10, 0, DateTimeKind.Unspecified), new TimeSpan(0, 1, 0, 0, 0)),
                            PaymentId = 1006,
                            Status = 6
                        });
                });
            ...
            modelBuilder.Entity("Bocian.Models.ProductCount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Bocian.Models.Order", b =>
                {
                    ...
                    b.HasOne("Bocian.Models.Employee", "Employee")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("Bocian.Models.Employee", b =>
                {
                    ...
                    b.HasOne("Bocian.Models.Shop", "Shop")
                        .WithMany("Employees")
